...
export function AquaInsightWizard() {
    ...
    <div className="w-full flex flex-col gap-6 my-8">
      ...
      >
        ...
        <div className="absolute top-4 right-4 z-30 flex items-center gap-2">
          ...
          <a
            href="https://aqua-insight-wizard.lovable.app"
            target="_blank"
        ...
        <iframe
          src="https://aqua-insight-wizard.lovable.app"
          title="Aqua Insight Wizard – Capstone Project"
          width="100%"
          height="100%"
          allowFullScreen
      ...
      <div className="bg-emerald-950/40 border-l-4 border-emerald-500 rounded-r-3xl p-6 md:p-8 shadow-xl backdrop-blur-xl border border-white/5">
        ...
        <ol className="list-decimal list-inside space-y-2 text-slate-300 font-medium text-sm md:text-base mb-4">
          <li>Download your final <strong className="text-white">Water Intelligence Report</strong>, <strong className="text-white">Advocacy Letter</strong>, and/or <strong className="text-white">Visual Dashboard</strong> from the app.</li>
          <li>Submit all required files (PDFs or screenshots) back to the LMS.</li>
        </ol>
        <div className="text-emerald-300/80 font-bold text-xs uppercase tracking-widest">
          Submission is mandatory to receive credit for this capstone experiential project!
        </div>
      </div>
    </div>
  );
